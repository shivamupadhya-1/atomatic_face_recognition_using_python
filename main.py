...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'shivamupadhyay1382@gmail.com' ")
...
def TrainImages():
    ...
    message1.configure(text=res)
    message.configure(text='Total Registered students  : ' + str(ID[0]))
...
def TrackImages():
    ...
    if exists3:
        ...
        mess._show(title='Data Missing', message='Please click on   to reset data!!')
        return
    harcascadePath = "haarcascade_frontalface_default.xml"
...
head2 = tk.Label(frame2, text="                        New Students Registration                       ", fg="black",bg="#3ece48" ,font=('times', 17, ' bold ') )
...
message1 = tk.Label(frame2, text="1)Take Images  >>>  2) " ,bg="#00aeff" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
...
if exists:
    ...
    res = 0
message.configure(text='Total Registered Students  : '+str(res))
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="black"  ,bg="#ea2a2a"  ,width=11 ,activebackground = "white" ,font=('tallios', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="black"  ,bg="#ea2a2a"  ,width=11 , activebackground = "white" ,font=('tallios', 11, ' bold '))
...
trackImg = tk.Button(frame1, text="Mark Attendence", command=TrackImages  ,fg="black"  ,bg="violet"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trackImg.place(x=30,y=50)
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy  ,fg="black"  ,bg="red"  ,width=35 ,height=1, activebackground = "white" ,font=('tallios', 15, ' bold '))
